...
<div id="encerrar"><a href= logout.php ><img src=../imagens/encerrar.png alt= Encerrar Sessão/><span><br>Encerrar<br>Sess&atilde;o</span></a></div>
	<div class="cadastro-card">
		...
		<form class="cadastro-form" action="cadastro_usuario.php" method="POST" onsubmit=" return validarTudo()">
			...
			<input type="password" name="senha" placeholder="AT&Eacute; 12 CARACTERES" id="senha" maxlength="12" required>
			...
			<input type="text" name="rua" placeholder="RUA/AVENIDA" id="rua" required>
			...
			<div><hr size="5" color="black"></div>
			<div>
				<h2>Informe a s&eacute;rie que ir&aacute; lecionar</h2>
				<p><input type="radio" name="serie" value="Gestao" id="gestao_s"><span>Gest&atilde;o</span></p>

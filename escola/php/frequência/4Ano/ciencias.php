...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequ&ecirc;ncia 4Ano - Ci&ecirc;ncias</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_ciencias.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequência 4 Ano - Ci&ecirc;ncias</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '4_CIEN' AND leciona.turma_serie = '4 Ano'");
                                    if($result){

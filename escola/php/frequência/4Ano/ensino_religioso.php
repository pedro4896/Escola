...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequ&ecirc;ncia 4Ano - Ensino Religioso</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_ensi_religioso.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequ&ecirc;ncia 4 Ano - Ensino Religioso</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '4_ENSI_RELI' AND leciona.turma_serie = '4 Ano'");
                                    if($result){
                                    ...
                                    echo("<td>Docente:".@$nome."</td><td>Disciplina: Ensino Religioso</td><td>S&eacute;rie: ".@$serie."</td><td colspan=2>Data: <input type=date name=data  id=data required></td>");
                                ?>
                            </tr>

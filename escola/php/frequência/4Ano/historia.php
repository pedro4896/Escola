...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequ&ecirc;ncia 4Ano - Hist&oacute;ria</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_historia.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequ&ecirc;ncia 4 Ano - Hist&oacute;ria</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '4_HIST' AND leciona.turma_serie = '4 Ano'");
                                    if($result){

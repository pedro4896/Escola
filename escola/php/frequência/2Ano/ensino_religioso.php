...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequ&ecirc;ncia 2Ano - Ensino Religioso</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_ensi_religioso.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequ&ecirc;ncia 2 Ano - Ensino Religioso</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '2_ENSI_RELI' AND leciona.turma_serie = '2 Ano'");
                                    if($result){

...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequência Jardim2 - Natureza e Sociedade</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_nat_soci.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequência Jardim 2 - Natureza e Sociedade</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = 'J2_MAT' AND leciona.turma_serie = 'Jardim 2'");
                                    if($result){
                            ...
                            <tbody id=tbody>
                                <?php
                                    $result = $banco->query("SELECT * FROM discentes WHERE turma_serie = 'Jardim 2' AND situacao = 'Deferido' ORDER BY nome ASC;");
                                    if($result){
                                        $cont = 1;
                                        foreach($result as $linha){
                                            echo("<tr>");

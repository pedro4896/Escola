...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequência Jardim2 - Portugu&ecirc;s</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_portugues.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequência Jardim 2 - Portugu&ecirc;s</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = 'J2_PORT' AND leciona.turma_serie = 'Jardim 2'");
                                    if($result){

...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequ&ecirc;ncia 5Ano - Matem&aacute;tica</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_matematica.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequ&ecirc;ncia 5 Ano - Matem&aacute;tica</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '5_MAT' AND leciona.turma_serie = '5 Ano'");
                                    if($result){

...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequ&ecirc;ncia 1Ano - Ci&ecirc;ncias</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_ciencias.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequência 1 Ano - Ci&ecirc;ncias</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '1_CIEN' AND leciona.turma_serie = '1 Ano'");
                                    if($result){

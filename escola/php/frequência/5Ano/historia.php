...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequ&ecirc;ncia 5Ano - Hist&oacute;ria</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_historia.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequ&ecirc;ncia 5 Ano - Hist&oacute;ria</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '5_HIST' AND leciona.turma_serie = '5 Ano'");
                                    if($result){
                                    ...
                                    echo("<td>Docente:".@$nome."</td><td>Disciplina: Hist&oacute;ria</td><td>S&eacute;rie: ".@$serie."</td><td colspan=2>Data: <input type=date name=data  id=data required></td>");
                                ?>
                            </tr>

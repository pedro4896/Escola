...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequ&ecirc;ncia 6Ano - Ci&ecirc;ncias</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_ciencias.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequência 6 Ano - Ci&ecirc;ncias</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '6_CIEN' AND leciona.turma_serie = '6 Ano'");
                                    if($result){
                                    ...
                                    echo("<td>Docente:".@$nome."</td><td>Disciplina: Ci&ecirc;ncias</td><td>S&eacute;rie: ".@$serie."</td><td colspan=2>Data: <input type=date name=data  id=data required></td>");
                                ?>
                            </tr>

...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequ&ecirc;ncia 6Ano - Portugu&ecirc;s</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_portugues.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequ&ecirc;ncia 6 Ano - Portugu&ecirc;s</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '6_PORT' AND leciona.turma_serie = '6 Ano'");
                                    if($result){

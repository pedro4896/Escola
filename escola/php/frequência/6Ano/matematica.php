...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequ&ecirc;ncia 6Ano - Matem&aacute;tica</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_matematica.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequ&ecirc;ncia 6 Ano - Matem&aacute;tica</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '6_MAT' AND leciona.turma_serie = '6 Ano'");
                                    if($result){

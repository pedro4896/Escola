...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequ&ecirc;ncia 6Ano - Educa&ccedil;&atilde;o F&iacute;sica</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_ed_fisica.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequ&ecirc;ncia 6 Ano - Educa&ccedil;&atilde;o F&iacute;sica</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '6_ED_FISI' AND leciona.turma_serie = '6 Ano'");
                                    if($result){
                            ...
                            <tbody id=tbody>
                                <?php
                                    $result = $banco->query("SELECT * FROM discentes WHERE turma_serie = '6 Ano' AND situacao = 'Deferido' ORDER BY nome ASC;");
                                    if($result){
                                        $cont = 1;
                                        foreach($result as $linha){
                                            echo("<tr>");

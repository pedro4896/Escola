...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequência 6Ano - Artes</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_artes.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequência 6 Ano - Artes</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '6_ART' AND leciona.turma_serie = '6 Ano'");
                                    if($result){
                                    ...
                                    echo("<td>Docente:".@$nome."</td><td>Disciplina: Artes</td><td>S&eacute;rie: ".@$serie."</td><td colspan=2>Data: <input type=date name=data  id=data required></td>");
                                ?>
                            </tr>

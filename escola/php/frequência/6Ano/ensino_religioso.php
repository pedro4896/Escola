...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequ&ecirc;ncia 6Ano - Ensino Religioso</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_ensi_religioso.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequ&ecirc;ncia 6 Ano - Ensino Religioso</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '6_ENSI_RELI' AND leciona.turma_serie = '6 Ano'");
                                    if($result){

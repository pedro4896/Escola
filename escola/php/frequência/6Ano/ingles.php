...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequ&ecirc;ncia 6Ano - Ingl&ecirc;s</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_ingles.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequ&ecirc;ncia 6 Ano - Ingl&ecirc;s</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '6_ING' AND leciona.turma_serie = '6 Ano'");
                                    if($result){

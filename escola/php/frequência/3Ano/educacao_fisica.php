...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequ&ecirc;ncia 3Ano - Educa&ccedil;&atilde;o F&iacute;sica</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_ed_fisica.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequ&ecirc;ncia 3 Ano - Educa&ccedil;&atilde;o F&iacute;sica</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = '3_ED_FISI' AND leciona.turma_serie = '3 Ano'");
                                    if($result){

...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequência Jardim1 - Portugu&ecirc;s</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_portugues.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequência Jardim 1 - Portugu&ecirc;s</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    WHERE ensina.codigo_disciplinas = 'J1_PORT' AND leciona.turma_serie = 'Jardim 1'");
                                    if($result){
                                    ...
                                    echo("<td>Docente:".@$nome."</td><td>Disciplina: Portugu&ecirc;s</td><td>S&eacute;rie: ".@$serie."</td><td colspan=2>Data: <input type=date name=data  id=data required></td>");
                                ?>
                            </tr>

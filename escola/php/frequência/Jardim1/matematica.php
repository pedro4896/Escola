...
<!DOCTYPE html>
            <html>
                <head>
                    ...
                    <title>Frequência Jardim1 - Matem&aacute;tica</title>
                ...
                <body> 
                    ...
                    <div><table>
                        <form action="frequencia_matematica.php" method="POST" onsubmit=" return validarTudo()">
                            <tr><th colspan=5>Frequência Jardim 1 - Matem&aacute;tica</th></tr>
                            <tr id=titulo>
                                <?php
                                    ...
                                    echo("<td>Docente:".@$nome."</td><td>Disciplina: Matem&aacute;tica</td><td>S&eacute;rie: ".@$serie."</td><td colspan=2>Data: <input type=date name=data  id=data required></td>");
                                ?>
                            </tr>
